                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("admin.guest-of-honor-templates.store") }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="date">{{ trans('cruds.guestOfHonorTemplate.fields.date') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="logo">{{ trans('cruds.guestOfHonorTemplate.fields.logo') }} <span class="text-danger">*</span></label> <br>
                            ...
                            <div class="form-group">
                                <label for="address">{{ trans('cruds.guestOfHonorTemplate.fields.address') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="body">{{ trans('cruds.guestOfHonorTemplate.fields.body') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="signature">{{ trans('cruds.guestOfHonorTemplate.fields.signature') }} <span class="text-danger">*</span></label>
                                        <br>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="name">{{ trans('cruds.guestOfHonorTemplate.fields.name') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="company_organisation">{{ trans('cruds.guestOfHonorTemplate.fields.company_organisation') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="phone_number">{{ trans('cruds.guestOfHonorTemplate.fields.phone_number') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="email">{{ trans('cruds.guestOfHonorTemplate.fields.email') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="website_link">{{ trans('cruds.guestOfHonorTemplate.fields.website_link') }} <span class="text-danger">*</span></label>
