                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("admin.speaker-templates.store") }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="logo">{{ trans('cruds.speakerTemplate.fields.logo') }} </label> <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="phone_number">{{ trans('cruds.speakerTemplate.fields.phone_number') }} </label>
