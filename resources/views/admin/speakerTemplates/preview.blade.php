...
@section('title')
      Speaker - {{ trans('panel.site_title') }}
@endsection
...
<div class="layout-px-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="page-header">
                <div class="page-header-1">
                    <h1 class="main-content-title tx-30">Speaker / Preview Template</h1>
                </div>
            </div>
        </div>
    </div>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success btn-lg" href="{{ route('admin.speaker-templates.edit',$template->id) }}">
                Edit Template
            </a>
            ...
            <a class="btn btn-warning btn-lg" href="{{ route('admin.speaker-send.page',$template->id)}}">Send Mail</a>
        </div>
    </div>
