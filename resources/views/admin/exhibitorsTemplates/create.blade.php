...
@section('title')
    Exhibitors Email Template - {{ trans('panel.site_title') }}
@endsection
    ...
    <div class="inner-body">
        ...
        <div class="page-header">
            <div class="page-header-1">
                <h1 class="main-content-title tx-30">Create Exhibitors Email Template</h1>
                {{-- <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Create Exhibitors Email Template</li>
                </ol> --}}
            </div>
        </div>
