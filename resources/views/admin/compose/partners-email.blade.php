        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="page-header">
                <div class="page-header-1">
                    <h1 class="main-content-title tx-30">Compose Partners Mail</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-12 col-lg-12  main-content-body-mail2">
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <form action="{{ route('admin.partners.emails')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class=" form-control select2 " name="emails[]" id="emails" multiple required>
                                        @foreach($partners as $key => $recepient)
