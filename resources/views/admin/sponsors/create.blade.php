    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sponsors.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="subject">{{ trans('cruds.sponsor.fields.subject') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="logo">{{ trans('cruds.sponsor.fields.logo') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.sponsor.fields.logo_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="date">{{ trans('cruds.sponsor.fields.date') }}</label>
            ...
            <div class="form-group">
                <label for="address">{{ trans('cruds.sponsor.fields.address') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="ref">{{ trans('cruds.sponsor.fields.ref') }}</label>
            ...
            <div class="form-group">
                <label for="body">{{ trans('cruds.sponsor.fields.body') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="signature">{{ trans('cruds.sponsor.fields.signature') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.sponsor.fields.signature_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="required" for="company_organisation">{{ trans('cruds.sponsor.fields.company_organisation') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="phone_number">{{ trans('cruds.sponsor.fields.phone_number') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="website_link">{{ trans('cruds.sponsor.fields.website_link') }}</label>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '/admin/sponsors/ckmedia', true);
...
<script>
    ...
    init: function () {
@if(isset($sponsor) && $sponsor->signature)
      var file = {!! json_encode($sponsor->signature) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview)
      file.previewElement.classList.add('dz-complete')
