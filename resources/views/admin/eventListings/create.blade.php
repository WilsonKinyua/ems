    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.event-listings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_name') ? 'is-invalid' : '' }}" type="text" name="event_name" id="event_name" value="{{ old('event_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('event_description') ? 'is-invalid' : '' }}" name="event_description" id="event_description">{!! old('event_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('event_category') ? 'is-invalid' : '' }}" name="event_category_id" id="event_category_id" required>
                    @foreach($event_categories as $id => $event_category)
                        <option value="{{ $id }}" {{ old('event_category_id') == $id ? 'selected' : '' }}>{{ $event_category }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('event_start_date') ? 'is-invalid' : '' }}" type="text" name="event_start_date" id="event_start_date" value="{{ old('event_start_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('event_end_date') ? 'is-invalid' : '' }}" type="text" name="event_end_date" id="event_end_date" value="{{ old('event_end_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eventsponsors') ? 'is-invalid' : '' }}" type="text" name="eventsponsors" id="eventsponsors" value="{{ old('eventsponsors', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_link') ? 'is-invalid' : '' }}" type="text" name="google_link" id="google_link" value="{{ old('google_link', '') }}">
