...
@section('title')
    Custom Email Template - {{ trans('panel.site_title') }}
@endsection
    ...
    <div class="inner-body">
        ...
        <div class="page-header">
            <div class="page-header-1">
                <h1 class="main-content-title tx-30">Create Custom Email Template</h1>
                {{-- <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Create Media Email Template</li>
                </ol> --}}
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route("admin.customs-templates.store") }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="date">{{ trans('cruds.customsTemplate.fields.date') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="logo">{{ trans('cruds.customsTemplate.fields.logo') }} <span class="text-danger">*</span></label> <br>
                            ...
                            <div class="form-group">
                                <label for="address">{{ trans('cruds.customsTemplate.fields.address') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="body">{{ trans('cruds.customsTemplate.fields.body') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="signature">{{ trans('cruds.customsTemplate.fields.signature') }} <span class="text-danger">*</span></label>
                                        <br>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="name">{{ trans('cruds.customsTemplate.fields.name') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="company_organisation">{{ trans('cruds.customsTemplate.fields.company_organisation') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="phone_number">{{ trans('cruds.customsTemplate.fields.phone_number') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="email">{{ trans('cruds.customsTemplate.fields.email') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required" for="website_link">{{ trans('cruds.customsTemplate.fields.website_link') }} <span class="text-danger">*</span></label>
