...
<div class="layout-px-spacing">
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success btn-lg" href="{{ route('admin.customs-templates.edit',$template->id) }}">
                Edit Template
            </a>
            {{-- <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                Send
            </button>
            @include('modals.customs') --}}
            <a class="btn btn-warning btn-lg" href="{{ route('admin.customs-send.page',$template->id)}}">Send Mail</a>
        </div>
    </div>
