...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('self_reg/fonts/icomoon/style.css')}}">


  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="{{ asset('self_reg/css/bootstrap.min.css')}}">

  <!-- Style -->
  <link rel="stylesheet" href="{{ asset('self_reg/css/style.css')}}">

  <title>Self Registration - {{ trans('panel.site_title') }}</title>
  <!-- Favicon -->
      ...
      <div class="row">
        <div class="col-md-5 mr-auto">
          ...
          <p>Dolor aliquid, commodi vitae dolorum veniam amet error! Nemo nam quibusdam delectus dolore eveniet officia
            ...
            vero facilis blanditiis explicabo sapiente consequatur provident? </p>

        </div>

        <div class="col-md-6">
          <div class="box">
            <h3 class="heading">Fill all the fields to continue </h3>
            <form class="mb-5" method="post" id="contactForm" name="contactForm" action="{{ route('speaker.create-self')}}">
                @csrf
              <div class="row">
                <input type="hidden" class="form-control" name="created_by_id" id="created_by_id" value="{{ $id }}" required>
                <div class="col-md-6 form-group">
                  <label for="name" class="col-form-label">Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="name" id="name" placeholder="Your name" value="{{ old('name', '') }}" required>
                </div>
                <div class="col-md-6 form-group">
                  <label for="name" class="col-form-label">Phone <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="phone" id="organization"
