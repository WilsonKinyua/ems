...
@section('title')
      Preview Media Template - {{ trans('panel.site_title') }}
@endsection
...
<div class="layout-px-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="page-header">
                <div class="page-header-1">
                    <h1 class="main-content-title tx-30">Preview Media Template</h1>
                </div>
            </div>
        </div>
    </div>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success btn-lg" href="{{ route('admin.media-templates.edit',$template->id) }}">
                Edit Template
            </a>
            {{-- <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                Send
            </button>
            @include('modals.medias') --}}
            <a class="btn btn-warning btn-lg" href="{{ route('admin.media-send.page',$template->id)}}">Send Mail</a>
        </div>
    </div>
