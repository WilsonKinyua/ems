...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{{ asset('reg_log/fonts/material-icon/css/material-design-iconic-font.min.css')}}">

    <!-- Main css -->
    <link rel="stylesheet" href="{{ asset('reg_log/css/style.css') }}">
            <style>
                .form-control {
                    display: block;
                    width: 100%;
...
<body>
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input type="number" name="mobile" class="form-input{{ $errors->has('mobile') ? ' is-invalid' : '' }}" required placeholder="Enter Mobile" value="{{ old('mobile', null) }}">
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" class="form-input{{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" required placeholder="{{ trans('global.login_password') }}">
    ...
    <!-- JS -->
    <script src="{{ asset('reg_log/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{ asset('reg_log/js/main.js')}}"></script>
</body>
</html>
