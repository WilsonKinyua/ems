...
class GuestOfHonorSendingEmailsController extends Controller
{

    public function store(Request $request) {

        // template details
        $template_details = GuestOfHonorTemplate::findOrFail($request->id);
        ...
        foreach ($id as $key => $value) {
            ...
            $guest = GuestOfHonor::find($value); //find user details
         ...
         return redirect()->route('admin.guest-of-honors.index')->with('success', 'Email sent successfully');
